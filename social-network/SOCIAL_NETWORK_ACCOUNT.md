...
accounts[0].id # =>  1
accounts[0].email_address # =>  'marta.bianchini@domain.com'
accounts[0].username # =>  'user_1'

accounts[1].id # =>  2
accounts[1].email_address # =>  'name.surname@domain.com'
...
account.id # =>  1
account.email_address # =>  'marta.bianchini@domain.com'
...
new_account.email = 'email_address@domain.com'
...
expect(new_account.email).to eq 'email_address@domain.com'
...
expect(accounts.fist.id).to eq "2"
